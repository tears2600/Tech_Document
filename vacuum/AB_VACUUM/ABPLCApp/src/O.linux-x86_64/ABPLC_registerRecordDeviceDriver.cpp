...
/* Generated from ../O.Common/ABPLC.dbd */
...
int ABPLC_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/hjson/epics/R3.14.12.5/siteApps/AB_VACUUM";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"ABPLC_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    ABPLC_registerRecordDeviceDriver(*iocshPpdbbase);
}
