...
/* Generated from ../O.Common/lsplc.dbd */
...
int lsplc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/sonhyungjoo/epics/R3.14.12.5/siteApps/lsplcModbus";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"lsplc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    lsplc_registerRecordDeviceDriver(*iocshPpdbbase);
}
